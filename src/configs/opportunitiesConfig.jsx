    ...
    materials: [
        ...
        },
        {
            ...
            jobs: [
                {
                    id: 'dsvmdhelpr',
                    title: <><ColoredSpan>Подручный сталевара</ColoredSpan> / Горновой</>,
                    desc: 'Помогает вести плавку: готовит шихту (сырье), берет пробы раскаленного металла, следит за состоянием печи и желобов. Учится управлять «огнем и металлом»'
                },
                {
                    id: 'fdbrckd',
                    title: <><ColoredSpan>Сталевар</ColoredSpan> / Плавильщик металла</>,
                ...
                },
                {
                    ...
                    title: <><ColoredSpan>Мастер участка </ColoredSpan> / Технолог-металлург</>,
                    desc: 'Организует работу бригады, контролирует соблюдение технологии плавки или проката, следит за качеством продукции и безопасностью на участке'
                },
            ]
        },
        {
            ...
            jobs: [
                {
                    ...
                    desc: 'анализирует данные технических систем, ключевые параметры работы оборудования и помогает выявлять отклонения и прогнозировать результат'
                },
                {
                    id: 'sewdfvsvet',
                    title: <ColoredSpan>Программист</ColoredSpan>,
                    desc: 'разрабатывает и настраивает программные алгоритмы для систем управления, пишет скрипты и оптимизирует работу технических процессов'
                },
                {
                    id: 'ecopdmcmt',
                    title: <ColoredSpan>Менеджер</ColoredSpan>,
                    desc: 'координирует работу команды и управляет реализацией технических проектов'
                },
            ]
        },
    ],
            ...
            jobs: [
                {
                    ...
                    desc: 'Участвует в проектировании и приемке объектов связи, оформляет отчеты и работает с техническими подразделениями',
                    skills: [
                        {
                            name: 'внимательность',
                            width: 100,
