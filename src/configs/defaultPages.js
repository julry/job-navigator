...
import chemT from '../assets/images/default/chemical_top.webp';
import chemB from '../assets/images/default/chemical_bot.webp';
import itT from '../assets/images/default/itTop.webp';
import itB from '../assets/images/default/itBot.webp';
import infosecT from '../assets/images/default/infoSecTop.webp';
import infosecB from '../assets/images/default/infoSecBot.webp';
import biotechB from '../assets/images/default/biotechBot.webp';
import biotechT from '../assets/images/default/biotechTop.webp';
import geologyB from '../assets/images/default/geologyBot.webp';
import geologyT from '../assets/images/default/geologyTop.webp';
import safetechB from '../assets/images/default/safetechBot.webp';
import safetechT from '../assets/images/default/safetechTop.webp';
import energeticsB from '../assets/images/default/energeticsBot.webp';
import energeticsT from '../assets/images/default/energeticsTop.webp';
import machineB from '../assets/images/default/machineBot.webp';
import machineT from '../assets/images/default/machineTop.webp';
import materialsB from '../assets/images/default/materialsBot.webp';
import materialsT from '../assets/images/default/materialsTop.webp';
import transportB from '../assets/images/default/transportBot.webp';
import transportT from '../assets/images/default/transportTop.webp';
import techcontrolB from '../assets/images/default/techcontrolBot.webp';
import techcontrolT from '../assets/images/default/techcontrolTop.webp';
import techpromB from '../assets/images/default/techpromBot.webp';
import techpromT from '../assets/images/default/techpromTop.webp';
import agroB from '../assets/images/default/agroBot.webp';
import agroT from '../assets/images/default/agroTop.webp';
import serviceB from '../assets/images/default/serviceBot.webp';
import serviceT from '../assets/images/default/serviceTop.webp';
import educationB from '../assets/images/default/educationBot.webp';
import educationT from '../assets/images/default/educationTop.webp';
...
export const defaultPages = [
    ...
    },
    {
        ...
        vacanciesDescr: [
            { id: 0, name: <NoTransformSpan>IT-компании и IT-интеграторы</NoTransformSpan>, desc: 'Проектировать цифровые системы, которые делают бизнес эффективнее' },
            { id: 1, name: 'Логистические и транспортные операторы', desc: 'Автоматизировать маршруты и управлять потоками грузов в реальном времени' },
            { id: 2, name: 'Железнодорожный транспорт и метрополитен', desc: 'Внедрять умные системы управления движением поездов' },
            { id: 3, name: 'Энергетические и инфраструктурные компании', desc: 'Заниматься автоматизацией работы государственных информационных систем и приложений' },
            { id: 3, name: 'Бизнес и производство', desc: 'Помогать автоматизировать производство, чтобы оно работало быстрее, стабильнее и с меньшими затратами' },
            { id: 3, name: 'Государственные органы', desc: 'Заниматься автоматизацией работы государственных систем и приложений' },
        ],
        vacanciesLinks: [
    ...
    },
    {
        ...
        jobDescriptionSm: 'Здесь создают комфорт, эмоции и качество жизни.\n\nСпециалисты этой сферы делают жизнь людей удобной, вкусной и красивой.\n\nОни управляют процессами, от которых зависит наше настроение и безопасность: готовят кулинарные шедевры, создают стильные образы, обеспечивают уют в отелях, комфорт в поездах и исправную работу техники в домах. Эта работа на стыке творчества, технологий и психологии, где главная цель — предвосхитить желание\nклиента и сделать всё\nпо высшему стандарту',
        vacanciesDescr: [
            { id: 0, name: 'Гостиницы, отели и санатории', desc: 'Создавать незабываемый опыт и атмосферу заботы для гостей' },
            { id: 1, name: 'Рестораны, кафе и кондитерские', desc: 'Делать каждый визит клиента событием через сервис и внимание к деталям' },
            { id: 2, name: 'Салоны красоты, студии стиля и флористики', desc: 'Помогать людям чувствовать себя уверенно и красиво' },
            { id: 3, name: 'Транспортные компании (РЖД, аэропорты)', desc: 'Обеспечивать комфорт и безопасность в пути для тысяч пассажиров' },
            { id: 4, name: 'Туроператоры и ивент-агентства', desc: 'Организовывать отдых и мероприятия, которые запомнятся людям на всю жизнь' },
            { id: 5, name: 'Сервисные службы ЖКХ и технического обслуживания', desc: 'Делать жизнь людей удобнее, решая бытовые вопросы быстро и качественно' },
        ],
        vacanciesLinks: [
        ...
        testQuestions: [
            {
                id: 'q-0',
                text: 'знаю стандарты обслуживания и санитарные нормы (СанПиН)'
            },
            {
                id: 'q-1',
    ...
    },
    {
        ...
        jobDescription: 'Педагог — профессия, которая создает будущее.\n\nспециалисты передают знания, раскрывая потенциаллюдей, формируя личность и вдохновляя на развитие.\n\nони знакомят малышей с миром, становятся первым и главным учителем для школьников, открывают таланты в кружках и секциях и передают профессиональные секреты будущим рабочим и специалистам',
