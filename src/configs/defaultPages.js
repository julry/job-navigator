...
export const defaultPages = [
    ...
    },
    {
        ...
        testQuestions: [
            {
                id: 'q-0',
                text: 'Умею мыслить системно',
            },
            {
                id: 'q-1',
                text: 'Готов постоянно обучаться',
            },
            {
                id: 'q-2',
                text: 'Понимаю, какие процессы можно автоматизировать в разных сферах',
            },
            {
                id: 'q-3',
                text: 'Знаю язык программирования',
            },
            {
                id: 'q-7',
    ...
    },
    {
        ...
        jobDescription: 'здесь создают комфорт, впечатление и красоту. специалисты организуют отдых и путешествия, делают стильные стрижки и создают уют в доме.\n\nони управляют сложными процессами, требующими одновременно творческого подхода, технических знаний и безупречных коммуникаций.\n\nэта работа на стыке гостеприимства, гастрономии, эстетики и организации быта, где стандартные услуги превращаются в индивидуальный опыт, а главный результат — это довольный клиент',
        jobDescriptionSm: 'здесь создают комфорт, впечатление и красоту. специалисты организуют отдых и путешествия, делают стильные стрижки и создают уют в доме.\n\nони управляют сложными процессами, требующими одновременно творческого подхода, технических знаний и безупречных коммуникаций.\n\nэта работа на стыке гостеприимства, гастрономии, эстетики и организации быта, где стандартные услуги превращаются в индивидуальный\nопыт, а главный результат —\nэто довольный клиент',
        vacanciesDescr: [
    ...
    },
    {
        ...
        vacanciesDescr: [
            { id: 0, name: 'детские сады и ясли'},
            { id: 1, name: 'школы (начальные классы)'},
            { id: 2, name: 'центры детского творчества, спортивные школы и студии'},
