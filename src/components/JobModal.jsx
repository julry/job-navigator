...
export const JobModal = ({ opportunities, id, onClose, picture, menuPerson = defaultMenuPerson, menuPersonHead = defaultMenuHead }) => {
    ...
    return (
        ...
        >
            ...
            >
                 <MenuBlockDesktop>
                    <DesktopLines>
                        <ModalLinesDesk amount={opportunities.length} active={chosenId}/>
                    </DesktopLines>
                    <MenuContent>
                        {opportunities.map(({text, id}) => (
                            <ButtonWrapper>
                                ...
                                <ButtonStyled onClick={() => handleChoose(id)} $isActive={id === chosen} $type='secondary'>{text}</ButtonStyled>
                            </ButtonWrapper>
                        ))}
                    </MenuContent>
                ...
                <CardsWrapper $bottom={pictureBottom}>
                    {jobs.map((job, index) => (
                        <Card key={job.id}>
                            <CardContent $withPicture={index === (jobs.length - 1) && hasPicture}>
                ...
                <MenuBlock>
                    ...
                    <MenuMan src={menuPerson} alt="" />
                    <MobileLines>
                        <ModalLines active={chosenId} amount={opportunities.length}/>
                    </MobileLines>
                    <MenuHead src={menuPersonHead} alt="" />
                    <MenuContent>
                        {opportunities.map(({text, id}) => (
                ...
                <UpButton onClick={scrollContentTop}>
                    <svg width="100%" height="100%" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20 31C20 31.5523 20.4477 32 21 32C21.5523 32 22 31.5523 22 31L21 31L20 31ZM21.7071 9.29289C21.3166 8.90237 20.6834 8.90237 20.2929 9.29289L13.9289 15.6569C13.5384 16.0474 13.5384 16.6805 13.9289 17.0711C14.3195 17.4616 14.9526 17.4616 15.3431 17.0711L21 11.4142L26.6569 17.0711C27.0474 17.4616 27.6805 17.4616 28.0711 17.0711C28.4616 16.6805 28.4616 16.0474 28.0711 15.6569L21.7071 9.29289ZM21 31L22 31L22 10L21 10L20 10L20 31L21 31Z" fill="var(--color-gray)"/>
                    <rect x="1" y="41" width="40" height="40" rx="20" transform="rotate(-90 1 41)" stroke="var(--color-gray)" stroke-width="2"/>
                    </svg>
                </UpButton>
