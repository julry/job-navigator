...
const textVariants = {
    default: 'посмотри, в каких направлениях и на каких позициях ты можешь начать работать',
    brand: 'посмотри, в каких направлениях и на каких позициях ты можешь начать работать',
}
