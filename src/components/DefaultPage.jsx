    ...
    return (
        <Wrapper>
            ...
            <SpacingContent>
                ...
                <Addictions ref={advicesRef} isDefault pageId={pageId} onClick={(data) => setModalState(prev =>( {...prev, ...data}))}/>
                ...
                <Footer>
                    ...
                    <BotFooterText>
                        <SmallText $color={'var(--color-gray)'}>{'перейти в бот'}</SmallText>
            ...
            <AnimatePresence>
                {modalState.shown && (
                    <JobModal onOpenBot={handleOpenBot} picture={[opportunitiesPerson, opportunitiesPersonDesk]}  opportunities={opportunities} id={modalState.id} onClose={handleCloseModal} />
                )}
            </AnimatePresence>
             <AnimatePresence>
                {isMenuOpen && (
