...
export const cards = [
    ...
    },
    {
        ...
        text: 'предложения от компаний, которым нужны начинающие специалисты без опыта. например, от «Алабуга Девелопмент», Билайна, ВТБ, Лемана про и FutureToday',
        src: speaker,
    },
    {
        id: 'advices',
    ...
    },
    {
        id: 'info',
        title: 'полезная инфа\nот работодателей',
        text: 'что ищут в новичках, как попасть на работу и чем ты на самом деле будешь на ней заниматься. рассказываем про 20 категорий специальностей',
        src: books,
    },
    {
        id: 'initialPrizes',
