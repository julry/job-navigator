...
export const About = ({ defaultColor, accentColor }) => (
    <>
        ...
        <TextWrapper $accentColor={accentColor}>
            ...
            <br />
            <Text $color={defaultColor}>
                за 16 лет мы реализовали 50+ проектов и построили инфраструктуру на 1,1 млрд долларов. у нас одна из сильнейших в стране команд: 800 инженеров, 60 сертифицированных руководителей проектов и центр компетенций по BIM-технологиям
            </Text>
            <br />
            <Text $color={defaultColor}>
